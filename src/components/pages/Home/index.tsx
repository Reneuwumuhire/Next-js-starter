...
export default function Home() {
	...
	const renderTechStack = () => (
		<Row gutter={16}>
			{TECH_STACK_INFO?.map((t) => (
				<IconCard key={t.name} text={t.name} iconPath={t.iconPath} iconSize={35} url={t.url} />
			))}
		</Row>
	);
	...
	const renderFooter = () => (
		<div className={styles.footer}>
			<p className={styles.footer_text}>This template was folked by me on 9th April 2024.</p>
			<CustomAvatar image="/images/author.png" mainText="Rene Uwumuhire" subText="reneuwumuhire" />
		</div>
	);
